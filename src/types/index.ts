 ...
 * "classicRed" is the original Canada-inspired default; the other two are
 * the alternate palettes proposed in the theme audit (see
 ...
 */
export type AppColorScheme = "classicRed" | "oceanBlue" | "twilightIndigo";
